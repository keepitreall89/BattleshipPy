...
def generateBoards():
	...
	log = spylogger.spylog('f:/PythonOutput/battleshipGen1Log.txt')
	log.addLine('Started at: '+str(start))
	log.write()
	boardLogger = boardlogger.boardLog('g:/BattleshipValidlogs/ValidBoards_1_7.csv', 577)
	start = [1, 2, True, 9, 5, True, 7, 6, True, 9, 1, True, 7, 1, True]
